...
// SSTableReader provides read-only access to an immutable SSTable file.
//
...
// OpenSSTable opens an existing SSTable file, reads the footer, and
...
func (r *SSTableReader) Get(key []byte) (value []byte, found bool, tombstone bool, err error) {
...
func (r *SSTableReader) BlockCount() int {
	return len(r.index)
}
